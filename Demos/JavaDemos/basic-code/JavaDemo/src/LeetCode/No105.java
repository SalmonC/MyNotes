...
public class No105 {
    ...
    public static void main(String[] args) {
        ...
        public static TreeNode buildTree(int[] preorder, int[] inorder) {
            ...
            return seperate(pre, in);

        }
        public static TreeNode seperate(List<Integer> pre, List<Integer> in){
            ...
            for(int i = 0; i < in.size(); i++){
                int tmp = pre.get(0);
                if(in.get(i) == pre.get(0))flag = true;
                else if(flag){
            ...
            node.left = seperate(leftPre, leftIn);
            node.right = seperate(rightPre, rightIn);
            return node;
        }
